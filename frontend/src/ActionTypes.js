...
export const FETCH = 'simple/FETCH';
export const FETCH_SUCCESS = 'simple/FETCH_SUCCESS';
export const FETCH_FAIL = 'simple/FETCH_FAIL';

export const LOGIN = 'authentication/LOGIN';
export const LOGIN_SUCCESS = 'authentication/LOGIN_SUCCESS';
export const LOGIN_FAIL = 'authentication/LOGIN_FAIL';
export const LOGIN_REDIRECT = 'authentication/LOGIN_REDIRECT';
